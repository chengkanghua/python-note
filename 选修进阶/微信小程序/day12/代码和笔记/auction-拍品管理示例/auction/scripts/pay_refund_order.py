...
def func(trade_no, out_refund_no, total_fee, refund_fee):
    """
    订单号
    ...
    print(xml)
    res = requests.post('https://api.mch.weixin.qq.com/secapi/pay/refund',
...
if __name__ == '__main__':
    ...
    print(out_refund_no)
    func('8ccdbbd652d9ad12b82cf2b021669cb9', out_refund_no, 0.1, 0.1)
