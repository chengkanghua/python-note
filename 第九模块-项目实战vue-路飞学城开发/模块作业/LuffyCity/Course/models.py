...
class Course(models.Model):
    ...
    # froeignkey 参数   blank主要用于form表单验证使用。 null 主要是用于写入数据库使用
    ...
    course_comments = GenericRelation("Comment")                # 课程评论
...
class CourseDetail(models.Model):
    """课程详细表"""
    course = models.OneToOneField(to="Course", on_delete=None)   # 与Course 一对一关系
    ...
    video_brief_link = models.CharField(max_length=255, blank=True, null=True,verbose_name="视频介绍链接")
    summary = models.TextField(max_length=2048, verbose_name="课程概述")
    why_study = models.TextField(verbose_name="为什么学习这门课程")
    what_to_study_brief = models.TextField(verbose_name="我将学到哪些内容")
    career_improvement = models.TextField(verbose_name="此项目如何有助于我的职业生涯")
    prerequisite = models.TextField(verbose_name="课程先修要求", max_length=1024)
    recommend_courses = models.ManyToManyField("Course", related_name="recommend_by", blank=True,verbose_name="课程推荐")
...
class CourseChapter(models.Model):
    ...
    class Meta:
        ...
        # db_table = verbose_name
        verbose_name_plural = verbose_name
        unique_together = ("course", "chapter")  # 联合唯一


class CourseSection(models.Model):
    """课时表"""
    # related_name作用  查询 CourseChapter.course_sections.all()
...
class PricePolicy(models.Model):
    ...
    valid_period = models.SmallIntegerField(choices=valid_period_choices,verbose_name="有效期限")
...
class OftenAskedQuestion(models.Model):
    ...
    answer = models.TextField(max_length=1024,verbose_name="答案")
...
class Account(models.Model):
    username = models.CharField(max_length=32,unique=True,blank=False,null=False, verbose_name="用户姓名")
    ...
    role = models.SmallIntegerField(blank=True,null=True,verbose_name='角色')
    def __str__(self):
