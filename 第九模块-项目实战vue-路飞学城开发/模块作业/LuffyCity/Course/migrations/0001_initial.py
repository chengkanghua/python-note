# Generated by Django 2.2 on 2022-02-21 08:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_brief_link', models.CharField(blank=True, max_length=255, null=True, verbose_name='视频介绍链接')),
                ...
                ('recommend_courses', models.ManyToManyField(blank=True, related_name='recommend_by', to='Course.Course', verbose_name='课程推荐')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_period', models.SmallIntegerField(choices=[(1, '1天'), (3, '3天'), (7, '1周'), (14, '2周'), (30, '1个月'), (60, '2个月'), (90, '3个月'), (120, '4个月'), (180, '6个月'), (210, '12个月'), (540, '18个月'), (720, '24个月'), (722, '24个月'), (723, '24个月')], verbose_name='有效期限')),
