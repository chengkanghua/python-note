直接分析web版本关键的 `x-zse-96`还是不对。

猜想：是不是app中和web中的算法不一样呢。（webview）



## 1.app嵌套页面

![image-20211116185108907](assets/image-20211116185108907.png)



把内容下载下来自己测试。

![image-20211116185230917](assets/image-20211116185230917.png)



![image-20211116185327816](assets/image-20211116185327816.png)



![image-20211116185421651](assets/image-20211116185421651.png)
