# Generated by Django 2.2 on 2019-06-25 13:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='class_teacher',
            field=models.ForeignKey(limit_choices_to={'depart__title': '班主任'}, on_delete=django.db.models.deletion.CASCADE, related_name='classes', to='web.UserInfo', verbose_name='班主任'),
        ),
        migrations.AlterField(
            model_name='classlist',
            name='tech_teachers',
            field=models.ManyToManyField(blank=True, limit_choices_to={'depart__title': '任课老师'}, null=True, related_name='teach_classes', to='web.UserInfo', verbose_name='任课老师'),
        ),
