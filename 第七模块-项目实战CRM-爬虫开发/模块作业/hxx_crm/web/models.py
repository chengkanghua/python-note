...
class ClassList(models.Model):
    ...
    school = models.ForeignKey(
        verbose_name='校区', to='School', on_delete=models.CASCADE)
    ...
    class_teacher = models.ForeignKey(
        verbose_name='班主任', to='UserInfo', on_delete=models.CASCADE, related_name='classes',
        limit_choices_to={'depart__title': '教务部'})
    tech_teachers = models.ManyToManyField(
        verbose_name='任课老师', to='UserInfo', related_name='teach_classes', blank=True,
...
class Customer(models.Model):
    ...
    客户表
    """
    MAX_PRIVATE_CUSTOMER = 150  # 最大可拥有私户数
