...
class PcBili(object):
    ...
    def heartbeat(self, conn, key):
        ...
        for i in range(1, loop_count + 1):
            ...
            conn.zadd(key, {json.dumps(context): self.start_ts + value}),
        ...
        conn.zadd(key, {json.dumps(context): self.start_ts + loop_count * 15 + div}),
