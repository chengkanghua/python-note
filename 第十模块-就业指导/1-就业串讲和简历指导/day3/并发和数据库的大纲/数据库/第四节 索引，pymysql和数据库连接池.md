...
![image-20220304172826867](assets/image-20220304172826867.png)
...
![image-20220304172836808](assets/image-20220304172836808.png)

​	在索引建立完毕后，以该字段为查询条件时，查询速度提升明显

　　　　![image-20220304172840648](assets/image-20220304172840648.png)
...
1. 范围问题，或者说条件不明确，条件中出现这些符号或关键字：>、>=、<、<=、!= 、between...and...、like
   ...
   **![image-20220304172846198](assets/image-20220304172846198.png)**
