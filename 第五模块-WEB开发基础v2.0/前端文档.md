...
![image-20210928155426547](assets/image-20210928155426547.png)
...
// 局部预编译第四步：
AO = {
        a:function a() {},  //在函数体里面找函数声明，值赋予函数体。
        b:undefined
        d:function d() {}  // 函数申明放在最后一部了
    }
```
...
var num3 = 10;
function func3(){
    console.log(num3);    //函数局部预编译的是会给 num3:undefined 值, 这里打印也是undefined
    var num3 = 20;       
}
func3();
console.log(num3); 
